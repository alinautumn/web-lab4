...
class Canvas extends React.Component {
    ...
    redrawCanvas() {
        ...
        const drawMainFigure = () => {
            this.ctx.fillStyle = 'rgba(200,162,200,0.34)';
            this.ctx.beginPath();
            this.ctx.moveTo(this.w / 2, this.h / 2 - Canvas.hatchGap);
            this.ctx.lineTo(this.w / 2, this.h / 2 - Canvas.hatchGap * 2);
            this.ctx.arc(this.w / 2, this.h / 2, Canvas.hatchGap * 2, 1.5 * Math.PI, 0, false);
            this.ctx.lineTo(this.w / 2 + Canvas.hatchGap * 2, this.h / 2 + Canvas.hatchGap * 2);
            this.ctx.lineTo(this.w / 2, this.h / 2 + Canvas.hatchGap * 2);
            ...
            this.ctx.fill();
            this.ctx.strokeStyle = 'rgba(147,112,219,0.87)'
            this.ctx.stroke();
            this.ctx.closePath();
        }
